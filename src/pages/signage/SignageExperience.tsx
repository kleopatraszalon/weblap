...
export function SignageExperience(){
  const[appearance,setAppearance]=useState<Appearance>(FALLBACK);const[popup,setPopup]=useState<Promo|null>(null);const[offers,setOffers]=useState<Promo[]>([]);const[idx,setIdx]=useState(0);
