...
export function KioskLanding(){
  ...
  if(theme.showStartScreen!==false&&!started){return <section className="kiosk-start-screen"><div className="kiosk-start-media" style={{backgroundImage:`linear-gradient(180deg,rgba(18,12,8,.08),rgba(18,12,8,.62)),url(${theme.heroImageUrl||"/images/szolgaltatasok.jpg"})`}}><div className="kiosk-pearl-stage" aria-hidden="true"><div className="kiosk-pearl-aura kiosk-pearl-aura-one"/><div className="kiosk-pearl-aura kiosk-pearl-aura-two"/><div className="kiosk-pearl-orbit"><i/><i/><i/></div><div className="kiosk-pearl-portrait"><img src="/images/home.png" alt=""/></div><div className="kiosk-pearl-chip kiosk-pearl-chip-ai"><span>✦</span><b>AI BEAUTY LAB</b><small>Személyes rutin 2 perc alatt</small></div><div className="kiosk-pearl-chip kiosk-pearl-chip-live"><i/><b>ÉLŐ SZALON</b><small>Gyöngyös · ma nyitva</small></div><div className="kiosk-pearl-index">K / 2026</div></div><div className="kiosk-silver-stage" aria-hidden="true"><div className="kiosk-silver-grid"/><div className="kiosk-silver-scan"/><div className="kiosk-silver-portrait"><img src="/images/home.png" alt=""/><i/></div><div className="kiosk-silver-reticle"><i/><i/><i/><i/></div><div className="kiosk-silver-readout"><span>BEAUTY SYSTEM</span><b>ONLINE</b><small>GYÖNGYÖS // 2026</small></div><div className="kiosk-silver-code">KLEO // SILVER // 03</div></div><div className="kiosk-kids-stage" aria-hidden="true"><div className="kiosk-kids-cloud one"/><div className="kiosk-kids-cloud two"/><div className="kiosk-kids-stars">✦　★　✧　★　✦</div><img className="kiosk-kids-bunny" src="/images/kiosk/kids/bunny.gif" alt=""/><img className="kiosk-kids-bear" src="/images/kiosk/kids/bear.gif" alt=""/><img className="kiosk-kids-fox" src="/images/kiosk/kids/fox.gif" alt=""/><div className="kiosk-kids-bubble">SZIA! 👋<small>Válassz velünk!</small></div></div><div className="kiosk-start-brand"><img src={theme.logoUrl||"/images/kleo_logo@2x.png"} alt="Kleopátra"/><span>{locationName}</span></div><div className="kiosk-start-copy"><span className="kiosk-start-kicker">ÖNKISZOLGÁLÓ KIOSK · GYÖNGYÖS</span><h1>{theme.startTitle||"Üdvözlünk a Kleopátra Szépségszalonban!"}</h1><p>{theme.startSubtitle||"Érintsd meg a képernyőt a választás megkezdéséhez."}</p><div className="kiosk-pearl-services"><span>HAJ</span><span>BŐR</span><span>KÖRÖM</span><span>WELLNESS</span></div><div className="kiosk-silver-services"><span>HAIR_01</span><span>SKIN_02</span><span>NAIL_03</span><span>WELLNESS_04</span></div><div className="kiosk-kids-services"><span>✂️ FRIZURA</span><span>✨ CSILLOGÁS</span><span>🌈 MÓKA</span></div></div><div className="kiosk-start-actions"><div className="kiosk-fixed-location"><span>HELYSZÍN</span><b>{locationName}</b></div><button className="kiosk-start-button" onClick={start}>{theme.startButtonText||"Kezdés"}<span>→</span></button></div></div></section>}
