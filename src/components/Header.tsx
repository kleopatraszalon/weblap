      ...
      <div className="container header-inner">
        <NavLink to="/" className="header-logo-link" aria-label="Főoldal">
          <div className="site-logo-wrapper site-logo-wrapper--shiny">
            <img src="/images/Logo.jpg" alt="Kleopátra Szépségszalonok logó" className="site-logo" />
          </div>
        </NavLink>
        ...
        <nav className="main-nav" aria-label="Fő navigáció">
          <div className="main-nav-inner">
            ...
            <div className="main-nav-row main-nav-row--bottom">
              ...
              <NavLink to="/education" className={navLinkClass}>{t("menu.education")}</NavLink>
            </div>
          </div>
        </nav>

        <div className="header-cta-block">
          <NavLink to="/booking" className="btn header-cta-btn" aria-label={t("header.booking")}>
            {t("header.booking")}
          </NavLink>
          <div className="header-social">
            <div className="header-social-label">{t("header.followUs")}</div>
            <div className="header-social-row">
              <div className="header-lang-switch" aria-label={t("header.language.label")}>
              ...
              <div className="header-social-icons">
                ...
                <a href="#" aria-label="TikTok"><img src="/images/tiktok.png" alt="TikTok" /></a>
                <a href="#" aria-label="Messenger"><img src="/images/messenger.png" alt="Messenger" /></a>
              </div>
            </div>
          </div>
        </div>
